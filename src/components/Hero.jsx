...
import { FiMail, FiPhone, FiMapPin, FiArrowDown, FiUsers } from 'react-icons/fi';
      ...
      >
        <motion.div className="hero__text">
          ...
          <motion.h1 className="hero__name" variants={item}>
            We are <span className="grad-text">{profile.team}</span>
          </motion.h1>
          ...
          <motion.p className="hero__summary" variants={item}>
            A small software team led by Ritchie Nalam — {profile.yearsExperience} years
            crafting scalable web &amp; mobile apps with Laravel, PHP, Vue.js, React
            Native &amp; TypeScript, turning complex problems into clean, user-friendly
            software.
          </motion.p>
          ...
          <motion.div className="hero__cta" variants={item}>
            <button className="btn btn--primary" onClick={() => scrollTo('projects')}>
              View Our Work <FiArrowDown />
            </button>
            <button className="btn btn--ghost" onClick={() => scrollTo('team')}>
              <FiUsers /> Meet the team
            </button>
          </motion.div>
        </motion.div>
